			...
			switch (opt) {
				case "reg":
					...
					if (typeof year === "undefined" || year === "")
						return await msg.reply("Need to input your birth year");
				...
				case "code":
					await msg.reply(
						`View Online: http://hiken.xyz/v/${args.slice(1)[0]}\nDownload: http://hiken.xyz/g/${
							args.slice(1)[0]
						}`
					);
					break;
				default:
					if (!userData[sender] || userData === "no_file")
						return await msg.reply("Please, register first\n!nuke reg <year of birth>");
