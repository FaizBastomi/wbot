        ...
        if (msg.message) {
            ...
            try {
                ...
                if (quoted.quotedMessage["ephemeralMessage"]) {
                    ...
                    msg.quoted = {
                        type: "normal",
                        mtype: Object.keys(quoted.quotedMessage).filter(v => v.includes("Message"))[0],
                        stanzaId: quoted.stanzaId, participant: quoted.participant.includes(":") ? quoted.participant.split(":")[0] + "@s.whatsapp.net" : quoted.participant,
                ...
                msg.quoted.text =
                    msg.quoted.message[msg.quoted.mtype] || msg.quoted.message[msg.quoted.mtype]?.text || msg.quoted.message[msg.quoted.mtype]?.description
