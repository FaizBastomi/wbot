...
const serialize = (msg, sock) => {
    if (msg?.message?.protocolMessage || msg?.message?.senderKeyDistributionMessage) {
        ...
        if (msg.message) {
            ...
            msg.body = msg.message.conversation || msg.message[msg.type].text || msg.message[msg.type].caption || (msg.type === "listResponseMessage") && msg.message[msg.type].singleSelectReply.selectedButtonId
